...
```{r correlate_external_groups, echo=F}
...
significantp <- data.p[,1:3]
threecolumncorr <- data.coeff[,1:3]
...
#KYRA LEFT OFF HERE- when next work on this will be running code as is again and actually looking at correlations to get some results, need to think of best way to visualize it
