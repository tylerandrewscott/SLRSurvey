...
Figure \@ref(fig:figure_choice_percentages) shows the percentage of respondents who selected each item.
```{r figure_choice_percentages, echo = F,message = F,warning = F,results = 'hide'}
